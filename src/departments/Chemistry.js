          ...
          <div class="col-4" style={{ height: "100%", minWidth: "90%!important" }}>
            ...
            <div class="list-group" id="list-tab" role="tablist" style={{ height: " 100%", width: "100%" }}>
              ...
              <a class="list-group-item list-group-item-action active .listclass" id="list-home-list"
                data-toggle="list" href="../documents/chemistry/fy.pdf" role="tab" aria-controls="home">F.Y.Chemistry Syllabus </a>

              <a class="list-group-item  list-group-item-action" id="list-profile-list" data-toggle="list"
                href="../documents/chemistry/sy.pdf" role="tab" aria-controls="profile">S.Y. Chemistry Syllabus </a>
            ...
            <div class="team-w3l-grid grid-2-team">
              ...
              <div class="col-md-4 col-sm-4 col-xs-4 about-poleft t1">
                <div class="about_img"><img src="images/t-staff/kalyani.jpg" height="100%" alt="" />
                  <h5 style={{ lineHeight: "20px" }}> <span style={{ fontSize: "20px", marginTop: "10px" }}>Asst. Prof Prof. Kalyani Kamble </span><span style={{ fontSize: "15px" }}>Asst. Prof</span></h5>
                  <div class="about_opa">
                    <p > Asst. Prof</p>
                  </div>
                </div>
