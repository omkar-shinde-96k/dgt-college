                    ...
                    <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div className="team-w3l-grid" style={{ border: "1px solid black" }}>
                            <div className="  about-poleft t1">
                                <div className="about_img"><img src="images/t-staff/acharya.jpg" height="100%" alt="prof.R.M. Acharya " />
                ...
                <div className="row">
                    <div className="col-4" style={{ height: "100%", minWidth: "90% !important" }}>
                        ...
                        <div className="list-group" id="list-tab" role="tablist" style={{ height: "100%", width: "100%" }}>
                            <h1 style={{ marginTop: "15px" }} className="text-center"> Marathi Syllabus </h1>
                            <br />
...
<br/>
                            ...
                            {/* <NavLink className="list-group-item list-group-item-action   .listclass" id="list-home-list"
            ...
            <div className="secoundnav">
                <h1 className="event-heading" align="center"><a>Events Of Marathi Departments</a> </h1> <br />
                <div className="events" >
                    <h3 className="events-title" align="center"> <span> मराठी भाषा गौरव दिन   </span> </h3> <br />
                    <div className="row md-2 events-img">
                        <a className="col-sm-12 col-lg-6" href="../documents/marathi/events/8.jpg"><img src="../documents/marathi/events/8.jpg" /></a>
                        <a className="col-sm-12 col-lg-6" href="../documents/marathi/events/6.jpg"><img src="../documents/marathi/events/6.jpg" /></a>
                    </div>
                </div>
            </div>
