                ...
                <div class="facility col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-12" data-aos="zoom-in">
                    <div className="sub-facility" style={{ display: "grid", placeItems: "center" }}>
                        ...
                        <p style={{ display: "flex", flexDirection: "column", height: "150px", placeItems: "center" }}>
                            <h3>Phone</h3>
                            <br />
                            <p>College Office:02140263928  <br /> <span>Principal : 9423203745/9075610653</span></p>
                        </p>
                    </div>
                </div>
                <div class="facility col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-12" data-aos="zoom-in">
                    <div className="sub-facility" style={{ display: "grid", placeItems: "center" }}>
                        ...
                        <p style={{ display: "flex", flexDirection: "column", height: "150px", placeItems: "center" }}>
                            ...
                            <br />
                            <p>
                                <a href="mailto:mspmmangaonseniorcollege@gmail.com"> College : mspmmangaonseniorcollege@gmail.com</a>
                                <br />
                                <span><a href="mailto:khamkarbm@gmail.com">Principal : khamkarbm@gmail.com</a></span>
                            </p>
                        </p>
                    </div>
                </div>
